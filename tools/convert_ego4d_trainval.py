...
slowfast_dir = '/SSD1/yj/ego4d/v1/slowfast8x8_r101_k400'
# omnivore_dir = '/SSD1/yj/ego4d/v1/omnivore_video_swinl'

# annotation files downloaded from Ego4D website
train_annot_path = '/SSD1/yj/ego4d/v1/annotations/moments_train.json'
val_annot_path = '/SSD1/yj/ego4d/v1/annotations/moments_val.json'

# label mapping
label_map_path = 'ego4d_label_map.txt'

# where to save the processed features
slowfast_out_dir = '/SSD1/yj/ego4d/converted/features/slowfast_features'
# omnivore_out_dir = '/SSD1/yj/ego4d/converted/features/omnivore_features'
...
annot_out_path = '/SSD1/yj/ego4d/converted/annotations/ego4d.json'
